...
export const Welcome = ({ onContinue }) => {
  ...
  return (
    <div className="welcome-container">
      ...
      {/* <!-- Button mit localhost zum Start der Spiels. --> */}
      <footer>
        <button
          onClick={() => {
            onContinue();
        ...
        {/* <!-- Javascript damit der Start Button Sound hat.---Noch nicht oben implenentiert!!--- --> */}
        <script type="text/javascript">
          const audio = new Audio(); audio.src = "/audio/Arlarm.mp3";
        </script>
        {/* <!-- ----------------------------------------------------------------------------------------- --> */}
      </footer>
    </div>
